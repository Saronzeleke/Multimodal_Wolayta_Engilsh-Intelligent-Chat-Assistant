import sys
import os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..")))  # 👈 Add early!
...
import pickle
import csv
from app.translation.translation import translate  # Assuming you have this function from your translation module
# === CONFIG ===
